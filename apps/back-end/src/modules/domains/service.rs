// src/modules/domains/service.rs
...
use crate::{
    config::AppConfig,
    entities::{domain, prelude::Domain, sea_orm_active_enums::DomainStatus},
    modules::domains::{
        dto::{AddDomainDto, DomainDto, VerifyDomainResultDto},
        utils::{canonicalize_and_validate_domain, derive_verification_token},
    },
    utils::dns::check_txt_contains,
};
