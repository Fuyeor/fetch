...
async fn main() {
    ...
    let app = Router::new()
        ...
        // Domain Routes
        .route("/domain", get(domain::list).post(domain::add))
        .route("/domain/:identifier", delete(domain::delete))
        .route("/domain/:identifier/verify", post(domain::verify))
        /*
          // Sitemap Routes
          .route("/domain/:identifier/sitemaps", get(sitemaps::list_sitemaps).post(sitemaps::submit_sitemap))
          // Ingestion Routes
          .route("/domain/:identifier/ingest", post(ingestions::trigger_ingest))
          .route("/domain/:identifier/ingestions", get(ingestions::list_ingestions))
        */
        .with_state(state);
